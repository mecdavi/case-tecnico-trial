			...
			<div class="row col-12">
				<div class="col-md-4 offset-md-4 col-xs-12 ">
					...
					<div class="row justify-around">
						<div class="q-pb-lg"><q-btn outline no-caps color="dark" class="q-px-xl" label="Login" title="Logins" @click="login()"/></div>
					</div>
				</div>
			</div>
		</q-page-container>
	...
	export default {
		...
		methods: {
			async login() {
				...
				var response = await this.$api.post('api/v1/login',this.form)
